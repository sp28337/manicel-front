...
import lavenderImg from "../../../../../../public/lavender-main-1200w.png";
...
import peachLavenderImg from "../../../../../../public/peach-lavender-500w.png";
import coconutPeachImg from "../../../../../../public/coconut-peach-500w.png";
import coconutLavenderImg from "../../../../../../public/coconut-lavender-500w.png";
import mintMangoImg from "../../../../../../public/mint-mango-500w.png";
        ...
        <header className={styles.header}>
            <div className={styles.background}>
                ...
                <Image
                    ...
                    src={backgroundElements[product.id]}
                    quality={100}
                    sizes="100vw"
                    priority
                />
                    ...
                    <div className={styles.wrapper}>
                        ...
                        <div className={styles.text}>
                            ...
                            <h1 className={styles.h1Wrapper}>
                                <span className={styles.h1}>{product.name}</span>
                                <span className={styles.span}>{product.category.name}</span>
                            </h1>
