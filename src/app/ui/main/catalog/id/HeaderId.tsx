...
import mangoElemsImg from "../../../../../../public/mango-elements.png";
import mintElemsImg from "../../../../../../public/mint-elements.png";
        ...
        <>
            <header className={styles.headerWrapper}>
                ...
                <Image
                    ...
                    src={imgBackgroundElements[product.id]}
                    quality={100}
                    sizes="100vw"
                    priority
                />
                    ...
                    <div className={styles.headerBody}>
                        <div className={styles.textHeader}>
                            <h1 className={styles.h1Header}>{product.name}
                                <br />
                                <span className={styles.spanHeader}>{product.category.name}</span>
                            </h1>
                            <ul className={styles.headerList}>
                                {effects.map((item: {description: string}, index: number) => (
                                    <li key={index} className={styles.headerListItem}>
                        ...
                        <div className={styles.imgWrapper}>
                            <Image 
                                ...
                                src={imgMainElements[product.id]} 
